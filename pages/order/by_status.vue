...
import PageLists from "@page_components/order-by-status/Lists.vue";
import PageForm from "@page_components/order-by-status/Form.vue";
...
export default {
    ...
    async created() {
        await this.assignPage('Orders by Status')
    },
    async mounted() {
        this.fetchEntry();
