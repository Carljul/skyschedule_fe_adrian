<template>
    <div>
        <div class="text-right">
            <button @click="$refs.newentrymodal.open = true"
                        ...
                        <div class="">
                            <div>
                                ...
                                <div class="form-group-wrap mb-2">
                                    <label for="new-firstname" class="mb-2 block text-xs font-medium --text-dark">User
                                        Photo</label>
                                    <dropzone-min :mimes="imageMimes" title="Employee Photo" :value="state.inputs.image"
                                        @input="e => {
                                            setState({ inputs: { ...state.inputs, image: e } });
                                        }" />
                                </div>

                                <ValidationProvider ref="newentry_name" name="name" v-slot="{ validate, errors }"
                                    rules="required">
                                    <div class="form-group-wrap mb-2">
                                        <label for="new-name" class="mb-2 block text-xs font-medium --text-dark">First
                                            Name</label>
                                        <input :value="state.inputs.name" @input="e => {
                                ...
                                <ValidationProvider ref="newentry_username" name="username" v-slot="{ validate, errors }"
                                    rules="required">
                                    <div class="form-group-wrap mb-2">
                                        <label for="new-username"
                                            class="mb-2 block text-xs font-medium --text-dark">Username</label>
                                        <input :value="state.inputs.username" @input="e => {
                                ...
                                <ValidationProvider ref="newentry_email" name="Email" v-slot="{ validate, errors }"
                                    rules="required|email">
                                    <div class="form-group-wrap mb-2">
                                        <label for="new-email"
                                            class="mb-2 block text-xs font-medium --text-dark">Email</label>
                                        <input :value="state.inputs.email" @input="e => {
                                ...
                                <ValidationProvider vid="newentry_password" ref="newentry_password" name="Password"
                                    v-slot="{ validate, errors }" rules="required|min:8">
                                    <div class="form-group-wrap mb-2">
                                        <label for="new-password"
                                            class="mb-2 block text-xs font-medium --text-dark">Password</label>
                                        <input :value="state.inputs.password" @input="e => {
                                ...
                                <ValidationProvider ref="newentry_password_confirmation" name="Confirm Password"
                                    ...
                                    <div class="form-group-wrap mb-3">
                                        ...
                                        <input :value="state.inputs.password_confirmation" @input="e => {
                                ...
                                <ValidationProvider ref="user_role" name="Role" v-slot="{ validate, errors }"
                                    rules="required">
                                    <div class="form-group-wrap mb-3">
                                        ...
                                        <t-select v-bind="$attrs" v-on="$listeners" :options="rolesOption" label="label"
                                            :clearable="false" :class="{ 'p-1.5': true }" @input="e => {
