                ...
                <form @submit.prevent="handleSubmit(savePostEntry)">
                    ...
                    <div class="form-group-wrap mb-3 mt-5">
                        ...
                        <textarea 
                            ...
                            type="text"
                            class="v-input bprint_type bprint_type-gray-300 --text-dark text-sm rounded block w-full px-3 p-2 input-focus-bprint_type"
                            ></textarea>
                    </div>
