        ...
        <div class="chat-media-files w-96 bg-white m-auto rounded-lg relative">
            ...
            <div class="p-5">
                <div class="modal-details">
                    <h3 class="profile-name text-xl">Edit Channel</h3>
                </div>
                <div>
                    <form ref="add_group_form" @submit.prevent="editGroup">
                        <div class="mt-2 mb-2">
                            <input @input="e => {
                        ...
                        <div class="mt-2">
                            <input  type="text" class="v-input border border-gray-300 --text-dark text-sm rounded block w-full px-3 p-2 input-focus-border" placeholder="Group Description" />
                        </div>
                        <div class="mt-2">
...
export default {  
    props: ['show_edit_message_function', 'openMediaFilesFunction'],
    computed: {
        ...mapState({
    ...
    methods: {
        ...
        async editGroup(){
            ...
            await this.StoreUpdateEntry(this.$route.params);
