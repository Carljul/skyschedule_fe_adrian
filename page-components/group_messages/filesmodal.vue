<template>
    <div class="chat-media-files-container fixed z-50 bg-opacity-40 w-full h-full bg-black top-0 left-0 flex">
        <div class="chat-media-files w-96 bg-white m-auto rounded-lg relative">
            ...
            <div class="p-5">
                <groupchanneldetails :groupHeaderTitle="groupHeaderTitle" :openMediaFilesFunction="openMediaFilesFunction"/>
                <div>
                    <memberslist :opeAddMemberFunction="opeAddMemberFunction" :opeRemoveMemberFunction="opeRemoveMemberFunction"/>
                </div>
...
<script>
import memberslist from "@page_components/group_messages/members.vue";
import groupchanneldetails from "@page_components/group_messages/groupchanneldetails.vue";
import removefilesmodal from "@page_components/group_messages/removefilesmodal.vue";

import { mapState, mapMutations, mapActions } from "vuex";
export default {
    props: ['openMediaFilesFunction', 'opeAddMemberFunction', 'opeRemoveMemberFunction', 'groupHeaderTitle'],
    components: {
        memberslist,
        groupchanneldetails,
        removefilesmodal
